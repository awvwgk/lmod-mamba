...
-- adjust prefix to actual installation, assumes default ~/mambaforge installation
local prefix = pathJoin(os.getenv["HOME"], "mambaforge")
...
if (myShellType() == "csh") then
  -- no mamba.csh for available
  cmd = "source " .. conda_sh .. "; conda activate base"
end
if (myShellType() == "sh") then
  cmd = "source " .. conda_sh .. "; source " .. mamba_sh .. "; mamba activate base"
end
...
if (myShellType() == "sh") then
  ...
  cmd = "conda deactivate; unset CONDA_EXE; unset _CE_CONDA; unset _CE_M; " ..
        ...
        "unset _CONDA_ROOT; unset -f conda; unset -f mamba"
  execute{cmd=cmd, modeA={"unload"}}
end
